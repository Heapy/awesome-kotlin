...
* https://github.com/sepatel/tekniq[sepatel/tekniq^] - An HTTP Framework DSL (tekniq-sparklin) like Node's Express or Ruby's Sinatra with Kotlin idiom.
...
* https://github.com/sepatel/tekniq[sepatel/tekniq^] - tekniq-jdbc creates extensions to the DataSource and Connection interfaces allowing easy interfacing with jdbc via kotlin idioms.
...
* https://github.com/sepatel/tekniq[sepatel/tekniq^] - tekniq-core supports without any added dependencies features like dynamic cache loading, configurations, and more.
...
* https://github.com/sepatel/tekniq[sepatel/tekniq^] - tekniq-rest provides a simple kotlin idiomatic way of handling HTTP requests.
