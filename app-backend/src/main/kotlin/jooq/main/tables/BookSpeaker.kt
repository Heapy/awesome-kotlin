...
open class BookSpeaker(
     ...
     */
    override fun where(condition: Condition?): BookSpeaker = BookSpeaker(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): BookSpeaker = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): BookSpeaker = where(DSL.notExists(select))
}
