...
open class ArticleTopic(
     ...
     */
    override fun where(condition: Condition?): ArticleTopic = ArticleTopic(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): ArticleTopic = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): ArticleTopic = where(DSL.notExists(select))
}
