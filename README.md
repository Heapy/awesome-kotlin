...
* [phodal/shire](https://github.com/phodal/shire) - Shire - AI Coding Agent Language (智能研发智能体语言), which can enables communication between an LLM and control IDE for automated programming.
