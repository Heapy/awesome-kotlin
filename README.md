...
* [stuebingerb/KGraphQL](https://github.com/stuebingerb/KGraphQL) - A GraphQL implementation written in Kotlin
...
* [clovis-ai/prepared](https://opensavvy.gitlab.io/groundwork/prepared/docs/index.html) - Magicless testing framework for Kotlin Multiplatform, featuring time management, parameterization and isolated features.
...
* [Anamorphosee/stacktrace-decoroutinator](https://github.com/Anamorphosee/stacktrace-decoroutinator) - Library for recovering stack traces in Kotlin coroutines.
...
* [mbalatsko/emailverifier-kt](https://github.com/mbalatsko/emailverifier-kt) - Composable, pluggable Kotlin library for validating email addresses beyond just their syntax. It's built with a clear focus: help developers reliably assess whether a given email is real, meaningful, and worth accepting.
...
* [clovis-ai/ktmongo](https://opensavvy.gitlab.io/ktmongo/docs) - Modern typesafe MongoDB DSL for Kotlin.
...
* [kakao/actionbase](https://github.com/kakao/actionbase) - Database for user interactions (likes, views, follows) with precomputed reads at write time.
...
* [clovis-ai/Dokka-MkDocs](https://opensavvy.gitlab.io/automation/dokka-material-mkdocs/docs) - Embed your kdoc comments into an MkDocs website.
* [sapotero/DocGenPlugin](https://plugins.jetbrains.com/plugin/26488-kdocgen) - KDocGen – an IntelliJ IDEA plugin that automatically generates KDoc, completes missing code, creates Kotest tests, and adds meaningful comments with a single shortcut!
* [L-Briand/TT](https://github.com/L-Briand/TT) - A powerful key:value template processor.
* [CLOVIS-AI/Kotlin-Transitive-Resources](https://github.com/CLOVIS-AI/Kotlin-Transitive-Resources) - Include resource files into a KotlinJS library
...
* [guimauvedigital/zodable](https://github.com/guimauvedigital/zodable) - Generate zod &amp; pydantic schemas from Kotlin data classes.
...
* [CLOVIS-AI/gitlab.main.kts](https://opensavvy.gitlab.io/automation/gitlab-ci.kt/docs/) - Replace your GitLab CI YAML files by Kotlin scripts
...
* [iCalDAV/iCalDAV](https://github.com/iCalDAV/iCalDAV) - Modern CalDAV and iCalendar library for JVM and Android with sync engine, RFC 5545/4791/6578 support
...
* [guimauvedigital/kourier](https://github.com/guimauvedigital/kourier) - Pure Kotlin AMQP client and protocol implementation, optimized for KMP and coroutines.
...
* [sapotero/dice-db-client](https://github.com/sapotero/dice-db-client) - DiceDB Kotlin Client - strongly typed, coroutine-based, and easy to use.
* [jogakdal/data-processors-with-excel](https://github.com/jogakdal/data-processors-with-excel) - A template-based Excel report generator for Kotlin/JVM. Bind data to Excel templates with support for list expansion, charts, conditional formatting, and streaming mode.
...
* [eignex/kpermute](https://github.com/eignex/kpermute) - Use bijective integer permutations with fast cycle-walking hash mixing to shuffle lists too big for memory or for ID obfuscation.
...
* [daniel-rusu/pods4k](https://github.com/daniel-rusu/pods4k) - Performance-oriented data structures for Kotlin, including Immutable Arrays
...
* [muhrifqii/ParseRSS](https://github.com/muhrifqii/ParseRSS) - Extensible kotlin library to parse RSS for android, included with retrofit and fuel converter factory
...
* [ivangarzab/barK](https://github.com/ivangarzab/barK) - Kotlin multiplatform logging library with automatic tag detection and test run support
...
* [kronos-orm/kronos-orm](https://github.com/kronos-orm/kronos-orm) - A modern ORM framework designed for Kotlin based on the compiler plugin, which is suitable for both backend and mobile applications, support multi-database. Powerful, high performance, easy to use.
...
* [kuvasz-uptime/kuvasz](https://github.com/kuvasz-uptime/kuvasz) - Kuvasz is an open-source, self-hosted uptime &amp; SSL monitoring service, built with Kotlin.
...
* [iamgio/quarkdown](https://github.com/iamgio/quarkdown) - Markdown-based typesetting system for papers, presentations, static sites, and more.
...
* [kseongbin/CrashWatcher](https://github.com/kseongbin/CrashWatcher) - Lightweight crash and ANR detection library with detailed stack traces and device info. Zero permissions required.
* [iamironz/android-nvim-plugin](https://github.com/iamironz/android-nvim-plugin) - Neovim plugin for Android/Gradle build, deploy, and logcat.
