...
val android = category("Android") {
  subcategory("Libraries") {
    ...
    link {
      ...
      type = github
      tags = arrayOf("android", "AsyncTasks")
    }
    link {
      ...
      type = github
      tags = arrayOf("android", "annotation processing")
    }
    link {
      ...
      type = github
      tags = arrayOf("android", "react", "view")
    }
    link {
      ...
      type = github
      tags = arrayOf("android", "SharedPreferences")
    }
    link {
      ...
      type = github
      tags = arrayOf("android", "RecyclerView", "ViewHolder")
    }
    link {
    ...
    link {
      ...
      type = github
      tags = arrayOf("async", "await", "android")
    }
    link {
      name = "jupf/staticlog"
  ...
  subcategory("Frameworks") {
    ...
    link {
      ...
      type = github
      tags = arrayOf("kotson", "anko", "android")
    }
  }
  subcategory("Projects") {
    ...
    link {
      ...
      type = github
      tags = arrayOf("android", "application", "tuner")
    }
    link {
      ...
      type = github
      tags = arrayOf("android", "application")
    }
    link {
    ...
    link {
      ...
      type = github
      tags = arrayOf("android", "application", "rx")
    }
    link {
      ...
      type = github
      tags = arrayOf("Java", "Groovy", "Scala", "Kotlin", "Android")
    }
    link {
    ...
    link {
      ...
      type = github
      tags = arrayOf("android", "twitter", "application")
    }
  }
